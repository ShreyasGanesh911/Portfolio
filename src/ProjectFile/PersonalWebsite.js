    ...
    <>
        ...
        <div className=' mx-5 project-container-img' id='project-container-img' >
          ...
          <motion.div id='project-content' initial={{opacity:0,x:-30}} whileInView={{opacity:1,x:0}} viewport={{once:true}} transition={{delay:0.2,duration:1}} className='project-content text-white displayFlex'>
            ...
            <p className='text-white mx-5 ' style={{textAlign:'justify'}}>My personal portfolio website is a showcase of my web development skills and projects. Through a clean and responsive design, I present a collection of websites and web applications I've created.</p>
