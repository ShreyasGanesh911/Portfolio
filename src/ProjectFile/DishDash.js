  ...
  return (
    <>
        ...
        <div className=' mx-5 project-container-img' id='project-container-img'>
          ...
          <motion.div initial={{opacity:0,x:-30}} id='project-content' whileInView={{opacity:1,x:0}} viewport={{once:true}} transition={{delay:0.2,duration:1}} className='text-white project-content displayFlex mx-3'>
            ...
            <p className='text-white mx-4 ' style={{textAlign:'justify'}}>I used express for building the online food ordering app DishDash. The app is easy to navigate and contains a checkout portion which provides a full user experience. The design is straightforward and responsive.</p>
            ...
            <div className='my-3 mx-4'>
              ...
              <button type="button" className="btn btn-outline-warning mx-2">Live Demo <i class="fa-solid fa-arrow-up-right-from-square" style={{color: '#f3f4f7'}}></i></button>
            </div>
          </motion.div>   
        </div>
    </>
